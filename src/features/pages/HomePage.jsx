        ...
        <section className="homeContainer">
            ...
            <article className="homeSection">
                <p className="homeP">
                    ...
                    ¡podemos adaptarnos a tus necesidades! El objetivo principal de AI Tasks es acercar
                    los avances de la IA a la comunidad hispanohablante.
                </p>
                <div className="svgContainer">
                    <Ai />
                </div>
                <p className="homeP">
                    Queremos hacer que estas tecnologías sean accesibles y fáciles de usar para cualquier persona
                    interesada, sin importar su nivel de experiencia en IA. Creemos que al proporcionar herramientas
                    poderosas y educativas, podemos ayudar a más personas a comprender y beneficiarse de las
                    aplicaciones prácticas de la IA en su vida diaria.
                </p>
            </article>
            <article className="homeSection">
                <p className="homeP">
